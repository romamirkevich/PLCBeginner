...
**Запустіть редактор EcoStruxure Machine Expert - Basic**
...
Рис. 1.10алаштування дискретних входів процесорного модуля
...
### **Огляд робочої області програмування**
...
Перейдіть до вкладки **Programming**, створіть програму, використавши такі інструменти мови програмування **LD** як **Contact** та **Coil**, знайти які можна на панелі інструментів (рис. 1.13).
 ...
 **Таблиці анімацій** є складовою програми EcoStruxure Machine Expert - Basic, і тому вони завантажуються в контролер як частина **непрограмних** даних разом з програмою.
...
![](C:\КтПЗ_3курс\GIT\PLCBeginer2\Лаборат\media1\pic_19.PNG)
...
14.         Які режими роботи ПЛК Ви знаєте? Чим відрізняються ці режими? Чи може програма в ПЛК працювати без комп’ютера з EcoStruxure Machine Expert - Basic?  
