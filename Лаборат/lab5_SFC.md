...
###### 1.1. Створення програми.

Створіть Grafcet POU і реалізуйте програму у відповідності до рисунка нижче

![](media5/26.png)

Задайте в якості умови переходів спрацювання %I0.0 для Tr1 і %I0.1 для Tr2. Step1 і Step2 залишайте порожніми.

![](media5/27.png)

![](media5/28.png)

Запустіть імітатор, змінюючи %I0.0 і %I0.1, перевірте зміну активності кроків.

![](media5/29.png)

###### 1.2. Паралельне розгалуження.
...
Як і для попередньої програми зробіть перевірку активності кроків.

![](media5/32.png)

###### 1.3. Альтернативне розгалуження.

Для реалізації альтернативного розгалуження, новий крок потрібно з'єднувати не з умовами переходу, а з іншими кроками.

![](media5/33.png)

Реалізуйте програму як на рисунку. Для кожної умови переходу використовуйте наступну вільну адресу %І.
...
###### 3.2. Модернізуйте код попередньої лабораторної роботи. 

Перепишіть логіку програми з допомогою Grafcet, імітатор об'єкта залишається в POU.

###### 3.3. Перевірка програми користувача.
